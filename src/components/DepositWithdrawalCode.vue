<template>
  <div class="booking-code" @click="hideModal">
    <div class="booking-code-share">
      <div class="booking-code-title">Your {{ data.type }} Code</div>
      <div>
      ...
      <div class="booking-code-desc">Take this to any of our shops to complete the process.</div>
...
function copyBookingCode() {
  const textToCopy = props.data.code
...
function redirectToPlatform(platform) {
  let message = `Here is my ${props.data.type} code: ${props.data.code}`
  switch (platform) {
    case 'whatsapp':
